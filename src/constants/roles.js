...
export const RO_STATUSES = [
  ...
  },
  {
    key: 'qc',
    label: 'QC',
    color: 'bg-lime-100 text-lime-800 dark:bg-lime-950 dark:text-lime-300',
...
export const PARTS_STATUSES = [
  { key: 'not_ordered',        label: 'Not Ordered',        color: 'bg-gray-100 text-gray-600 dark:bg-zinc-800 dark:text-zinc-400'     },
  { key: 'ordered',            label: 'Ordered',            color: 'bg-blue-100 text-blue-700 dark:bg-blue-950 dark:text-blue-300'     },
  { key: 'partially_received', label: 'Partial',            color: 'bg-amber-100 text-amber-700 dark:bg-amber-950 dark:text-amber-300' },
  { key: 'all_received',       label: 'All Received',       color: 'bg-green-100 text-green-700 dark:bg-green-950 dark:text-green-300' },
]
...
export const STATUS_GROUPS = [
  {
    ...
    header:   'text-gray-600 dark:text-zinc-400',
    accent:   'border-gray-300 dark:border-zinc-700',
  },
  {
    key:      'BODY',
    label:    'Body',
  ...
  },
  {
    key:      'SUBLET',
    label:    'Sublet',
    statuses: [],    // no dedicated status key — cards tagged sublet manually (future)
