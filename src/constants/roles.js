...
export const CAR_STATUSES = [
  { key: 'pending_dropoff', label: 'Pending Drop-Off', color: 'bg-orange-100 text-orange-800 dark:bg-orange-900/60 dark:text-orange-200', icon: '○' },
  { key: 'car_in_shop',     label: 'Car In Shop',      color: 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/60 dark:text-emerald-200', icon: '●' },
]
